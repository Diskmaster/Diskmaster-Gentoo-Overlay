...
src_prepare() {
    epatch "${FILESDIR}/fix_qa_issue.patch" # Fix EVIOCGUSAGE related issues. Based on Fedora #723427's patch
    epatch "${FILESDIR}/regenerate_nativedefines.patch" # ant -f plugins/linux/src/native/build.xml createNativeDefinitions.java
